...
public class ReservationSpecification extends BaseSpecification {
    ...
    @Test
    public void reserve01_findCarsByTypeFindsMatchingCars() {
        // given
        setUpTestData();
    ...
    @Test
    public void reserve02_findCarsByLocationFindsMatchingCars() {
        // given
        setUpTestData();
        ...
        // and when
        cars = carSharingDao.findCarsBy(null, wien);
        assertThat(cars.size(), is(1));
        assertThat(cars.contains(car3), is(true));
    }
    @Test
    public void reserve03_findCarsByNameAndLocationFindsMatchingCars() {
        // given
        setUpTestData();
    ...
    @Test
    public void reserve04_findCarsByNeitherNameNorLocationReturnsAllCars() {
        // given
        setUpTestData();
    ...
    @Test
    public void reserve04_findCustomerByLastnameFindsMatchingCustomers() {
        // given
        setUpTestData();
    ...
    @Test
    public void reserve05_findCustomerByFirstnameFindsMatchingCustomers() {
        // given
        setUpTestData();
    ...
    @Test
    public void reserve06_findCustomerByLastnameAndFirstnameFindsMatchingCustomers() {
        // given
        setUpTestData();
    ...
    @Test
    public void reserve07_findAvailableRidesInFindsAvailableRidesOfAllHotelsWithThatLocation() {
        // given
        setUpTestData();
    ...
    @Test
    public void reserve08_findAvailableRidesInUnknownLocationReturnsEmptyList() {
        // given
        setUpTestData();
    ...
    @Test
    public void reserve09_findRidesReservedForFindsRidesReservedByCustomer() {
        // given
        setUpTestData();
    ...
    @Test
    public void reserve10_findRidesReservedForUnknownCustomerReturnsEmptyList() {
        // given
        setUpTestData();
    ...
    @Test
    public void reserve11_reserveAssignsCustomerToRideAndReturnsTrue() {
        // given
        setUpTestData();
    ...
    @Test
    public void reserve12_reserveAlreadyBookedRideReturnsFalse() {
        // given
        setUpTestData();
    ...
    @Test
    public void reserve13_reserveForUnknownCustomerReturnsFalse() {
        // given
        setUpTestData();
    ...
    @Test
    public void reserve14_reserveNullAsRideReturnsFalse() {
        // given
        setUpTestData();
    ...
    @Test
    public void reserve15_reserveNotYetPersistedRideForCustomerReturnsFalse() {
        // given
        setUpTestData();
    ...
    @Test
    public void reserve16_cancelAssignsNullAsCustomerToRideAndReturnsTrue() {
        // given
        setUpTestData();
    ...
    @Test
    public void reserve17_cancelAvailableRideReturnsFalse() {
        // given
        setUpTestData();
    ...
    @Test
    public void reserve18_cancelRideForUnknownCustomerReturnsFalse() {
        // given
        setUpTestData();
    ...
    @Test
    public void reserve19_cancelNullAsRideReturnsFalse() {
        // given
        setUpTestData();
    ...
    @Test
    public void reserve20_cancelNotYetPersistedRideForCustomerReturnsFalse() {
        // given
        setUpTestData();
    ...
    @Test
    public void reserve21_tricky_findCustomersByNeitherLastnameNorFirstnameReturnsAllCustomers() {
        // given
        setUpTestData();
    ...
    @Test
    public void reserve22_tricky_findCarsBySearchesCaseInsensitiveForLocation() {
        // given
        setUpTestData();
    ...
    @Test
    public void reserve23_tricky_findCustomerSearchesCaseInsensitive() {
        // given
        setUpTestData();
    ...
    @Test
    public void reserve24_tricky_findAvailableRidesWithParameterNullReturnsAllAvailableRides() {
        // given
        setUpTestData();
    ...
    @Test
    public void reserve25_tricky_findAvailableRidesSearchesCaseInsensitive() {
        // given
        setUpTestData();
