...
public class IntegrationTest extends BaseSpecification {
    ...
    public void integrationTest() {
        ...
        assertThat(carSharingDao.findCarsBy(null, graz), hasItems(car1, car2));
        assertThat(carSharingDao.findCarsBy(null, wien), hasItems(car3));
        ...
        assertThat(carSharingDao.findAvailableRides(wien), hasItems(ride6, ride7));
        assertThat(carSharingDao.findCarsBy(null, graz), hasItems(car1));
