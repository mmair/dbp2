...
public interface CarSharingDao {
    ...
    /**
     * Liest den Customer mir der übergebenen Email aus der Datenbank.
     * Bei Übergabe von <code>null</code> wird <code>null</code> zurückgegeben.
     * @param email die Email des gewünschten Customer.
     ...
     * @return Liste der gebuchten Räume des Customers
     */
